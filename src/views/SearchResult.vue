    ...
    <div class="search-page">
        <div class="view-control">
            ...
            <span class="search-title"
                >搜索内容：{{ router.currentRoute.value.query.keywords }}</span
            >
        </div>
        <div class="search-container" ref="searchScroll">
            <div class="search-classify">
                <div class="classify-item">
                    ...
                    <div class="classify-content">
                        <LibrarySongList
                            :songlist="searchResult.searchSongs"
                            type="search"
                        ></LibrarySongList>
                    </div>
                </div>
                <div class="classify-item">
                    ...
                    <div class="classify-content">
                        <LibraryAlbumList
                            :albumlist="searchResult.searchAlbums"
                            type="search"
                        ></LibraryAlbumList>
                    </div>
                </div>
            ...
            <div class="search-classify-other">
                <div class="classify-item-other">
                    ...
                    <div class="content">
                        <SearchResultList
                            :listdata="searchResult.searchArtists"
                            type="artist"
                        ></SearchResultList>
                    </div>
                </div>
                <div class="classify-item-other">
                    ...
                    <div class="content">
                        <SearchResultList
                            :listdata="searchResult.searchPlaylists"
                            type="playlist"
                        ></SearchResultList>
                    </div>
                </div>
                <div class="classify-item-other">
                    ...
                    <div class="content">
                        <SearchResultList
                            :listdata="searchResult.searchMvs"
                            type="mv"
                        ></SearchResultList>
                    </div>
                </div>
