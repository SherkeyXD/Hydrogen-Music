        ...
        <div class="settings-container">
            ...
            <div class="settings-user-info" v-if="isLogin()">
                <div class="user">
                    <div class="user-head">
                        <img
                            :src="userStore.user.avatarUrl + '?param=300y300'"
                            alt=""
                        />
                    </div>
                    <div class="user-info">
                        ...
                        <div
                            class="user-vip"
                            v-if="vipInfo && userStore.user.vipType != 0"
                        >
            ...
            <div class="settings">
                <div class="settings-item">
                    ...
                    <div class="item-options">
                        ...
                        <div class="option" v-if="playerStore.musicVideo">
                            ...
                            <div class="option-operation">
                                <div class="button" @click="clearMusicVideo()">
                                    清除
                                </div>
                            </div>
                        </div>
                ...
                <div class="settings-item">
                    ...
                    >
                        ...
                        <div
                            class="default-shortcuts"
                            @click="setDefaultShortcuts()"
                        >
                            恢复默认快捷键
                        </div>
                    </div>
                        ...
                        <div class="option">
                            ...
                            <div class="option-operation">
                                <div
                                    class="toggle"
                                    @click="
                                        userStore.homePage = !userStore.homePage
                                    "
                                >
                                    <div
                                        class="toggle-off"
                                        :class="{
                                            'toggle-on-in': userStore.homePage,
                                        }"
                                    >
                                        {{
                                            userStore.homePage
