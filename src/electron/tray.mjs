...
export default function InitTray(win, app, iconPath) {
    let tray = null;
    let winIsShow = false;
    const Buttons = [
        {
            icon: nativeImage.createFromPath(
                path.resolve(__dirname, "../assets/icon/last.png"),
            ),
            tooltip: "上一首",
            click() {
        ...
        {
            icon: nativeImage.createFromPath(
                path.resolve(__dirname, "../assets/icon/play.png"),
            ),
            tooltip: "播放",
            click() {
        ...
        {
            icon: nativeImage.createFromPath(
                path.resolve(__dirname, "../assets/icon/pause.png"),
            ),
            tooltip: "暂停",
            flags: ["hidden"],
            click() {
        ...
        {
            icon: nativeImage.createFromPath(
                path.resolve(__dirname, "../assets/icon/next.png"),
            ),
            tooltip: "下一首",
            click() {
