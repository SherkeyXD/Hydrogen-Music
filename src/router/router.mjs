    ...
    },
    {
        ...
        children: [
            {
                ...
                beforeEnter: (to, from, next) => {
                    if (!libraryInfo.value || from.name != "playlist")
                        updateLibraryDetail(to.params.id, to.name);
                    next();
                },
            },
            {
                ...
                component: LibraryDetail,
                beforeEnter: (to, from, next) => {
                    if (!libraryInfo.value || from.name != "album")
                        updateLibraryDetail(to.params.id, to.name).then(() => {
                            next();
            ...
            },
            {
                ...
                component: LibraryDetail,
                beforeEnter: (to, from, next) => {
                    if (!libraryInfo.value || from.name != "artist")
                        updateLibraryDetail(to.params.id, to.name);
                    next();
                },
            },
            ...
            },
            {
                ...
                beforeEnter: (to, from, next) => {
                    if (from.name != "localFiles")
                        localStore.updateLocalMusicDetail(to.name, to.query);
                    next();
                },
            },
            {
                ...
                component: LocalMusicDetail,
                beforeEnter: (to, from, next) => {
                    if (from.name != "localAlbum")
                        localStore.updateLocalMusicDetail(
                            to.name,
                            null,
                            to.params.id,
                        );
        ...
        beforeEnter: (to, from, next) => {
            if (isLogin()) next();
                ...
                (from.name == "homepage" || from.name == "search") &&
                to.fullPath != "/mymusic"
            )
                next();
