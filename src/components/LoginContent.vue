    ...
    <div class="login-content" :class="{ jumpPage: jumpPage }">
        <div class="login-container">
            ...
            <LoginByQRCode
                ...
                v-show="loginMode == 0 && accountMode == 0"
            ></LoginByQRCode>
            <LoginByAccount
            ...
            <div class="login-other">
                ...
                <div
                    ...
                    v-show="loginMode == 0 && accountMode == 0"
                >
                    <span class="login-mail" @click="changeMode(0)"
                        >邮箱登录</span
                    >
                    <span class="separation">|</span>
                    <span class="login-phone" @click="changeMode(1)"
                        >手机登录</span
                    >
                </div>
...
.jumpPage {
    opacity: 0;
    transform: scale(0.4);
    transition: 0.6s 2.2s cubic-bezier(0.47, 0, 0.98, 0.58);
}
</style>
