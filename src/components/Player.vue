...
const toAlbum = () => {
    if (songList.value[currentIndex.value].type != "local") {
        router.push(
            "/mymusic/album/" + songList.value[currentIndex.value].al.id,
        );
...
<template>
    <div class="player-container">
        <div class="player">
            <div class="player-cover">
                <div
                    class="cover"
                    :class="{
                        'cover-change': playerChangeSong,
                        'back-Video': videoIsPlaying,
                    }"
                    @click="backToVideo()"
                >
                    <img
                        ...
                        :src="
                            songList[currentIndex].al.picUrl + '?param=600y600'
                        "
                        alt=""
                    />
                    <img
                    ...
                    <img
                        v-if="
                            songList[currentIndex].type == 'local' &&
                            !localBase64Img
                        "
            ...
            <div class="player-info">
                <div class="info-music">
                    <div
                        class="music-name-lable"
                        :class="{ 'music-name-lable-in': playerChangeSong }"
                    ></div>
                    <span
                        class="music-name"
                        :class="{ 'music-name-in': playerChangeSong }"
                        >{{
                            songList[currentIndex].name ||
                            songList[currentIndex].localName
                        }}</span
                    >
                </div>
                <div class="info-music">
                    <div
                        class="music-author-lable"
                        :class="{
                            'music-author-lable-video':
                                videoIsPlaying || coverBlur,
                        }"
                    ></div>
                    <div class="music-author">
                        <span
                            ...
                            >{{ singer.name || ""
                                ...
                                index == songList[currentIndex].ar.length - 1
                                    ? ""
                                    : " / "
                            }}</span
                        >
            ...
            <div class="song-control">
                ...
                <svg
                    t="1673182533775"
                    v-show="
                        lyricType.indexOf('roma') != -1 &&
                        lyricType.indexOf('noRoma') == -1
                    "
                ...
                <svg
                    t="1673182625534"
                    v-show="
                        lyricType.indexOf('trans') != -1 &&
                        lyricType.indexOf('noTrans') == -1
                    "
                ...
                <svg
                    ...
                    v-show="
                        ...
                        lyricType.indexOf('noOriginal') == -1
                    "
                ...
                >
                    <path
                        d="M545.472 32v837.504L947.2 467.712l44.544 46.144-478.08 478.144L32.128 510.4l44.48-44.544 405.248 403.712V32h63.616z"
                        p-id="5312"
                    ></path>
                </svg>
                <svg
        ...
        <PlayList
            class="playlist-widget-player"
            :class="{ 'playlist-widget-open': playlistWidgetShow }"
        ></PlayList>
        ...
        .player-cover {
            ...
            .cover {
                ...
                img {
                    ...
                    animation: cover-in 0.3s 0.65s cubic-bezier(0.4, 0, 0.12, 1)
                        forwards;
                    @keyframes cover-in {
                        0% {
                            transform: scale(1.03);
            ...
            .c-border1 {
                ...
                animation: border1 0.3s 0.65s cubic-bezier(0.4, 0, 0.12, 1)
                    forwards;
                @keyframes border1 {
                    0% {
                        top: 1vh;
            ...
            .c-border2 {
                ...
                animation: border2 0.2s 0.65s cubic-bezier(0.4, 0, 0.12, 1)
                    forwards;
                @keyframes border2 {
                    0% {
                        top: 1vh;
            ...
            .c-border3 {
                ...
                animation: border3 0.3s 0.65s cubic-bezier(0.4, 0, 0.12, 1)
                    forwards;
                @keyframes border3 {
                    0% {
                        bottom: 1vh;
            ...
            .c-border4 {
                ...
                animation: border4 0.3s 0.65s cubic-bezier(0.4, 0, 0.12, 1)
                    forwards;
                @keyframes border4 {
                    0% {
                        bottom: 1vh;
