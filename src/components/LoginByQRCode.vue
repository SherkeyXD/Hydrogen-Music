...
<template>
    <div class="qrcode-container" @click="checkStatus()">
        <div
            class="qrcode-border"
            :class="{
                'qrcode-loging-1': loging == 1,
                'qrcode-loging-1 qrcode-loging-2': loging == 2,
            }"
        >
            <div
                class="qrcode"
                :class="{
                    'qrcode-checking': loging == 2,
                    'qrcode-invalid': qrStatus == 800,
                    'qrcode-recover': loging == -2,
                }"
            >
                <img :src="qrcodeImg" alt="" v-show="qrcodeImg" />
                <span class="qrcode-loading" v-show="!qrcodeImg"
                    >Loading...</span
                >
            </div>
            <div
                ...
                :class="{
                    'qrcode-checking': loging == 2,
                    'status-1': qrStatus == 800,
                    'status-2': qrStatus == 802,
                    hide: loging == -2,
                }"
            >
                {{ statusTitle }}
