    ...
    <div class="music-widget">
        <div class="music-progress-container">
            ...
            <div class="music-time">
                {{ songTime2(progress) }} / {{ songTime2(time) }}
            </div>
        </div>
        <div class="music-info">
            <div class="music-img" @click="showPlayer()">
                <img
                    ...
                    :src="songList[currentIndex].al.picUrl + '?param=128y128'"
                    alt=""
                />
                <img
                    v-else
                ...
                <img
                    v-if="
                        ...
                        !localBase64Img
                    "
                    src="http://p3.music.126.net/UeTuwE7pvjBpypWLudqukA==/3132508627578625.jpg?param=128y128"
                    alt=""
                />
